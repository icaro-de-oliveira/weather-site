...
function mostrarClima(data) {
  ...
  climaTempEl.textContent = `${data.main.temp.toFixed(1)}°C`;
    ...
    .catch((error) => {
      ...
      ilustracaoDiv.innerHTML = `
        <svg width="120" height="80" viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg">
          <ellipse cx="60" cy="70" rx="50" ry="10" fill="#e0e7ef"/>
          <circle cx="40" cy="50" r="18" fill="#6d8cff"/>
          <circle cx="80" cy="55" r="12" fill="#a0c4ff"/>
          <circle cx="70" cy="40" r="6" fill="#fff"/>
          <rect x="55" y="60" width="10" height="10" rx="2" fill="#3b82f6"/>
          <text x="60" y="78" text-anchor="middle" font-size="10" fill="#888">?</text>
        </svg>
      `;
    });
});